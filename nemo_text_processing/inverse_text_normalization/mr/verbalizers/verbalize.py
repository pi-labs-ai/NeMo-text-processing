...
from nemo_text_processing.inverse_text_normalization.mr.verbalizers.ordinal import OrdinalFst
...
class VerbalizeFst(GraphFst):
    ...
    def __init__(self):
        ...
        graph = cardinal_graph | decimal_graph | ordinal_graph | time_graph | date_graph
        self.fst = graph
