...
class VerbalizeFinalFst(GraphFst):
    ...
    Finite state transducer that verbalizes an entire sentence
        e.g. tokens { cardinal { integer: "൨൩" } } tokens { name: "കേരളം" } -> ൨൩ കേരളം
    """
    ...
    def __init__(self):
        ...
        # Handle leading space, multiple tokens with extra space between them, and trailing space
