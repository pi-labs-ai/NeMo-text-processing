...
from nemo_text_processing.inverse_text_normalization.bn.graph_utils import NEMO_NOT_QUOTE, NEMO_SPACE, GraphFst, delete_space


class FractionFst(GraphFst):
    """
    Finite state transducer for verbalizing fractions
        e.g. fraction { numerator: "৮" denominator: "৩" } -> "৮/৩"
    """
