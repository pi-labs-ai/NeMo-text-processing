...
from nemo_text_processing.inverse_text_normalization.bn.graph_utils import NEMO_CHAR, GraphFst, delete_space


class MeasureFst(GraphFst):
    """
    Finite state transducer for verbalizing measure, e.g.
        measure { negative: "true" cardinal { integer: "১২" } units: "kg" } -> -১২ kg
        measure { decimal { negative: "true"  integer_part: "১২"  fractional_part: "৫০"} units: "kg" } -> -১২.৫০ kg
        measure { units: "address" cardinal { integer: "৭০০ ওক স্ট্রীট" } preserve_order: true } -> ৭০০ ওক স্ট্রীট
