...
# Malayalam digits
NEMO_ML_DIGIT = pynini.union("൦", "൧", "൨", "൩", "൪", "൫", "൬", "൭", "൮", "൯").optimize()
MALAYALAM_DIGIT = ["൦", "൧", "൨", "൩", "൪", "൫", "൬", "൭", "൮", "൯"]
...
# Malayalam words for negative/minus
MINUS = pynini.union("മൈനസ്", "ഋണ", "നെഗറ്റീവ്").optimize()


def integer_to_malayalam(n: int) -> str:
    """Convert integer to Malayalam numerals"""
    return ''.join(MALAYALAM_DIGIT[int(d)] for d in str(n))
