...
class OrdinalFst(GraphFst):
    ...
    Finite state transducer for classifying ordinal
        e.g. तेरावा -> ordinal { integer: "१३" morphosyntactic_features: "वा" }
    ...
    def __init__(self, cardinal: GraphFst):
        ...
        # Masculine ordinals with suffix वा or वे
        ...
        # Feminine ordinals with suffix वी
        ...
        rule = pynini.cdrewrite(morpho_graph, pynini.closure(NEMO_DIGIT), pynini.union("[EOS]", " "), NEMO_SIGMA)
