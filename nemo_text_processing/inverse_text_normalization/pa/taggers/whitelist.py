...
class WhiteListFst(GraphFst):
    """
    Finite state transducer for classifying whitelisted tokens (Punjabi)
        e.g. ਮਿਸਟਰ -> tokens { name: "Mr." }
    
    Whitelist entries are loaded from data/whitelist/whitelist.tsv
    """
